...
os_compat_int06:			; Invalid opcode handler
	...
	.msg db 10, 13, 10, 13, 'Bad opcode - restarting TomOS', 10, 13, 0
...
os_compat_int20:					; Exit app handler
	call _os_print_newline
	mov sp, [_os_execute_program.mainstack]		; Restore OS stack
	push cs						; Set the return address
	push word _os_execute_program.end_the_program	; CS:end_the_program
	iret						; Return to OS
